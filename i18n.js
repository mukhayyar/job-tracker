...
const UI_STRINGS = {
  id: {
    ...
    checklist_h1: 'Checklist per Lamaran',
    checklist_subtitle: 'Pilih lamaran untuk melihat dan mengisi checklist persiapannya — setiap perusahaan punya checklist sendiri.',
    checklist_empty_title: 'Belum ada lamaran',
    checklist_empty_desc: 'Tambahkan lamaran dulu di tab Tracker untuk mulai checklist per perusahaan.',
    checklist_avg_label: 'Rata-rata kesiapan',
    checklist_dialog_title_tpl: '✅ Checklist — {company}',
    btn_open_checklist: 'Buka Checklist',
    card_checklist_btn_tpl: '✅ {done}/{total}',
    btn_close: 'Tutup',
    btn_cl_reset: '↺ Reset checklist ini',
    ...
    jobs_h1: 'Cari Lowongan',
    jobs_subtitle: 'Lowongan terbaru dari Remotive, Arbeitnow, dan Jobicy — klik Tambah untuk memasukkannya ke tracker.',
    jobs_search_placeholder: '🔍 kata kunci (mis. frontend, data, marketing)...',
    jobs_source_label: 'Sumber',
    jobs_source_all: 'Semua sumber',
    jobs_btn_search: '🔍 Cari Lowongan',
    jobs_btn_searching: '⏳ Mencari...',
    jobs_add_btn: '➕ Tambah',
    jobs_added_btn: '✅ Tersimpan',
    jobs_view_btn: '🔗 Lowongan',
    jobs_result_count_tpl: '{n} lowongan ditemukan',
    jobs_empty_before: 'Masukkan kata kunci lalu klik Cari Lowongan. Hasil diambil langsung dari API publik Remotive, Arbeitnow, dan Jobicy.',
    jobs_empty_no_result: 'Tidak ada lowongan yang cocok. Coba kata kunci lain.',
    jobs_error_tpl: 'Gagal memuat lowongan ({message}). Coba lagi nanti.',
    jobs_attribution: 'Data lowongan oleh Remotive, Arbeitnow, dan Jobicy.',
    jobs_salary_tpl: '💰 {salary}',
    jobs_publication_tpl: '📅 {date}',
    ...
    checklist_postit_tpl: 'Rata-rata checklist: {pct}% dari {count} lamaran',
  ...
  en: {
    ...
    checklist_h1: 'Per-Application Checklist',
    checklist_subtitle: 'Pick an application to view and fill in its own preparation checklist — every company gets its own.',
    checklist_empty_title: 'No applications yet',
    checklist_empty_desc: 'Add an application in the Tracker tab first to start a per-company checklist.',
    checklist_avg_label: 'Average readiness',
    checklist_dialog_title_tpl: '✅ Checklist — {company}',
    btn_open_checklist: 'Open Checklist',
    card_checklist_btn_tpl: '✅ {done}/{total}',
    btn_close: 'Close',
    btn_cl_reset: '↺ Reset this checklist',
    ...
    jobs_h1: 'Job Search',
    jobs_subtitle: 'Fresh listings from Remotive, Arbeitnow, and Jobicy — click Add to put one straight into your tracker.',
    jobs_search_placeholder: '🔍 keyword (e.g. frontend, data, marketing)...',
    jobs_source_label: 'Source',
    jobs_source_all: 'All sources',
    jobs_btn_search: '🔍 Search Jobs',
    jobs_btn_searching: '⏳ Searching...',
    jobs_add_btn: '➕ Add',
    jobs_added_btn: '✅ Saved',
    jobs_view_btn: '🔗 Posting',
    jobs_result_count_tpl: '{n} jobs found',
    jobs_empty_before: 'Enter a keyword and click Search Jobs. Results are fetched live from the public Remotive, Arbeitnow, and Jobicy APIs.',
    jobs_empty_no_result: 'No matching jobs. Try a different keyword.',
    jobs_error_tpl: "Couldn't load jobs ({message}). Try again later.",
    jobs_attribution: 'Job data by Remotive, Arbeitnow, and Jobicy.',
    jobs_salary_tpl: '💰 {salary}',
    jobs_publication_tpl: '📅 {date}',
    ...
    checklist_postit_tpl: 'Average checklist: {pct}% across {count} applications',
